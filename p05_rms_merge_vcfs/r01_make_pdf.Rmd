...
# Make pdf report for genotyping step
...
\textbf{Total number of variants emitted by HC: `r n.all`\\} 
\fontsize{10}{16}\selectfont 
\textbf{Number of variants passed minimal filters: `r n.passed`\\}
\textbf{Minimal HC filter: QUAL > calling threshold (default 30, not emitted)\\}
\textbf{Minimal VQSR filter: VQSLOD > 0}
\end{center}
...
fa.pass.caption=paste("Variants frequent in 1k (passed min filters, n=",n.fa.pass,")", sep="")
